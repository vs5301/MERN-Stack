    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/generate-content' element={<AuthRoute><ContentGeneration /></AuthRoute>} />
          <Route path='/history' element={<AuthRoute><ContentGenerationHistory /></AuthRoute>} />
          <Route path='/' element={<Home />} />
          <Route path='/plans' element={<Plans />} />
          <Route path='/free-plan' element={<AuthRoute><FreePlanSignup /></AuthRoute>} />
          <Route path='/checkout/:plan' element={<AuthRoute><CheckoutForm /></AuthRoute>} />
