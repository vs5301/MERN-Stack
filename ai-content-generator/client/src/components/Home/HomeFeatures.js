    ...
    return (
        <div>
            <section className="relative py-12 md:py-24 lg:py-32 bg-gray-900 bg-body overflow-hidden">
                <img src={blink} alt="Blink" className='hidden sm:block absolute top-0 right-1/2 -mr-64 xl:mr-24 mt-12 h-20 animate-spinStar' />
                <img src={blink} alt="Blink" className='hidden sm:block absolute bottom-0 right-0 mb-64 mr-8 h-20 animate-spinStar' />
                <div className="relative container mx-auto px-4">
                    <div className="flex flex-wrap items-center -mx-4">
                        <div className="w-full lg:w-2/5 xl:w-1/2 px-4 mb-8 lg:mb-0">
                            <img src={ai1} alt="Features bg" className="block w-full max-w-md xl:max-w-lg" />
                        </div>
                                            ...
                                            <div className="slider-container">
                                                 <div className="slide flex mb-16 items-start">
                                                    ...
                                                    <div className="max-w-lg">
                                                        ...
                                                        <p className="text-xl text-gray-400">
                                                            InnovateGen AI Solutions transforms content creation as you know it. Our cutting-edge algorithms produce top-tier, captivating material, optimizing your time and elevating your creative productivity.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="slide flex mb-16 items-start">
                                                    ...
                                                    <div className="max-w-lg">
                                                        ...
                                                        <p className="text-xl text-gray-400">
                                                            Whether it's blog posts, marketing copy, or creative stories, InnovateGen AI Solutions customizes content to your exact specifications, ensuring each piece is impeccably suited to its intended purpose.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="slide flex items-start">
                                                    ...
                                                    <div className="max-w-lg">
                                                        ...
                                                        <p className="text-xl text-gray-400">
                                                            Integrating seamlessly with diverse platforms, InnovateGen AI Solutions seamlessly merges into your workflow, streamlining content generation with unprecedented efficiency.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
