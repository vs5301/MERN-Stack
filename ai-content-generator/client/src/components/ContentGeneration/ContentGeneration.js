    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
            <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-2xl w-full p-6">
                ...
                {/* Success */}
                {mutation?.isSuccess && (
                    <StatusMessage type="success" message="Content generation is successful" />
                )}
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="prompt" {...formik.getFieldProps("prompt")} placeholder='Enter a topic or idea' className="px-4 py-2 w-full border rounded-md focus:ring-2 focus:ring-indigo-500" />
                    ...
                    <div>
                        ...
                        <select id="tone" {...formik.getFieldProps("tone")} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <select id="category" {...formik.getFieldProps("category")} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
