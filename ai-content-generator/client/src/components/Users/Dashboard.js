                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="mb-6 bg-white p-4 shadow rounded-lg">
                        ...
                        <div>
                            <div className="mb-4">
                                ...
                                <p className="border rounded w-full py-4 px-3 text-gray-700 leading-tight" id="username">
                                    {data?.user?.username}
                                </p>
                            </div>
                            <div className="mb-4">
                                ...
                                <p className="border rounded w-full py-4 px-3 text-gray-700 leading-tight" id="email">
                                    {data?.user?.email}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="mb-6 bg-white p-4 shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="mb-4">
                                Next Billing Date:{" "}
                                {data?.user?.nextBillingDate ? data?.user?.trialExpires : "No Billing date"}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mb-6 bg-white p-4 shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <Link to="/plans" className=" py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Upgrade Plan
                            </Link>
                        </div>
                    </div>
                                        ...
                                        <li className="py-4 hover:bg-gray-50 transition duration-150 ease-in-out">
                                            <div className="flex flex-col sm:flex-row justify-between">
                                                ...
                                                <div className="flex items-center">
                                                    <p className={`text-lg fonrt-semibold ${ payment?.status === "success" ? "text-green-500" : "text-orange-500" }`}>
                                                        {payment?.status}
                                                    </p>
