          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
              ...
              <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
                ...
                <div className="w-full md:flex-1 md:pt-3">
                  ...
                  <p className="text-coolGray-500 font-medium">
                    Stop wasting time logging expenses and tracking your income by hand. Use our software to manage it all in one place.
                  </p>
                </div>
              </div>
              <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                <img src="https://cdn.pixabay.com/photo/2015/01/28/22/20/bookkeeping-615384_1280.jpg" alt="Home" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <p className="mb-6 text-lg md:text-xl text-coolGray-500 font-heading">
              Flex is a Small SaaS Business. Flex isn't a traditional company. We believe
              a diverse team, approaches to work and transparency are key to our success.
            </p>
            <a className="inline-flex items-center justify-center px-7 py-3 h-14 w-full md:w-auto text-lg leading-7 text-green-50 bg-green-500 hover:bg-green-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm" href="/#">
              Get Started
            </a>
          </div>
          <div className="relative max-w-4xl mx-auto">
            <img src="https://cdn.pixabay.com/photo/2015/01/28/22/20/bookkeeping-615384_1280.jpg" alt="Landing" className="relati" />
          </div>
        </div>
      </section>
    </div>
