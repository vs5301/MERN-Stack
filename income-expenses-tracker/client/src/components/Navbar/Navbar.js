                        ...
                        <div className="flex h-16 justify-between">
                            <div className="flex">
                                ...
                                <div className="flex-flex-shrink-0 items-center">
                                    <img src={logo} alt="Novotek" className="block h-8 w-auto lg:hidden" />
                                    <img src={logo} alt="Novotek" className="hidden h-8 w-auto lg:block" />
                                </div>
                            ...
                            {!token && (
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <Link to="/dashboard" className="relative inline-flex items-center rounded-md border border-transparent bg-indigo-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800">
