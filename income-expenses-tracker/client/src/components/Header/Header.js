                        ...
                        <div className="flex flex-wrap xl:items-center -mx-4">
                            <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                                ...
                                <p className="mb-8 text-lg md:text-xl text-gray-500 font-medium">
                                    Wondering where all your money goes each month? Tired of complicated
                                    budgeting software? Try our Simple Income & Expenses Tracker Application,
                                    the simple way to track your income and expenses in one place.
                                </p>
                                <div className="flex flex-wrap">
                                    ...
                                    <div className="w-full md:w-auto py-1 md:py-0">
                                        <a href="/#" className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 text-coolGray-800 font-medium text-center bg-white hover:bg-coolGray-100 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 border border-coolGray-200 rounded-md shadow-sm">
                                            Sign Up
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="w-full md:w-1/2 px-4">
                                <div className="relative mx-auto md:mr-0 max-w-max">
                                    <img src="https://cdn.pixabay.com/photo/2015/01/28/22/20/bookkeeping-615384_1280.jpg" alt="Landing" className="relative mx-auto md:mr-0 max-w max" />
                                </div>
                            </div>
                        </div>
                    </div>
